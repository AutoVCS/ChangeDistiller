...
public enum JavaEntityType implements EntityType {
    ...
    OTHER ( false ), // not used by CD itself, used for summarising things at
                     // the end

    DOCUMENTATION ( false ) // not used by CD itself, used for summarising
                            // things at the end
    ...
    private JavaEntityType ( final boolean isValidChange ) {
    ...
    public boolean isComment () {
        switch ( this ) {
            ...
            case JAVADOC:
            case LINE_COMMENT:
                /* general documentation, unspecified type */
            case DOCUMENTATION:
                return true;
            default:
                return false;
    ...
    public boolean isStatement () {
        switch ( this ) {
            ...
            case FOREACH_STATEMENT:
                // Fix for
                // https://bitbucket.org/sealuzh/tools-changedistiller/issue/22
