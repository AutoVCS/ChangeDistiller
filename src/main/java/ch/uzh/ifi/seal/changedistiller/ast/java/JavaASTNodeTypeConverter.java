...
import static ch.uzh.ifi.seal.changedistiller.model.classifiers.java.JavaEntityType.ANNOTATION;
...
import static ch.uzh.ifi.seal.changedistiller.model.classifiers.java.JavaEntityType.FUNCTIONAL_EXPRESSION;
...
import static ch.uzh.ifi.seal.changedistiller.model.classifiers.java.JavaEntityType.LAMBDA_EXPRESSION;
...
import static ch.uzh.ifi.seal.changedistiller.model.classifiers.java.JavaEntityType.RECORD_COMPONENT;
...
import static ch.uzh.ifi.seal.changedistiller.model.classifiers.java.JavaEntityType.SWITCH_EXPRESSION;
...
import static ch.uzh.ifi.seal.changedistiller.model.classifiers.java.JavaEntityType.YIELD_STATEMENT;
...
/**
 * Implementation of {@link ASTNodeTypeConverter} for the Java programming
 * language.
 *
 * @author Beat Fluri
...
public final class JavaASTNodeTypeConverter implements ASTNodeTypeConverter {
    ...
    private static Map<Class< ? extends ASTNode>, JavaEntityType> sConversionMap = new HashMap<Class< ? extends ASTNode>, JavaEntityType>();
    ...
    static {
        ...
        // Bug #14: Cannot distinguish between primitive and simple types
        // without resolving bindings
        ...
        sConversionMap.put( LambdaExpression.class, LAMBDA_EXPRESSION );
        sConversionMap.put( FunctionalExpression.class, FUNCTIONAL_EXPRESSION );

        sConversionMap.put( Annotation.class, ANNOTATION );
        sConversionMap.put( AnnotationMethodDeclaration.class, ANNOTATION );
        sConversionMap.put( NormalAnnotation.class, ANNOTATION );
        sConversionMap.put( SingleMemberAnnotation.class, ANNOTATION );
        sConversionMap.put( MarkerAnnotation.class, ANNOTATION );

        sConversionMap.put( SwitchExpression.class, SWITCH_EXPRESSION );

        sConversionMap.put( YieldStatement.class, YIELD_STATEMENT );

        sConversionMap.put( RecordComponent.class, RECORD_COMPONENT );

        sConversionMap.put( CompactConstructorDeclaration.class, METHOD );

    }

    @Override
    public EntityType convertNode ( final Object node ) {
