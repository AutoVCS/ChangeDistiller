...
public class JavaStructureNode implements StructureNode {
    ...
    private final List<JavaStructureNode> fChildren;
     ...
     */
    public JavaStructureNode ( final Type type, final String qualifier, final String name, final ASTNode astNode ) {
        fType = type;
     ...
     *            to add as child
     */
    public void addChild ( final JavaStructureNode node ) {
        fChildren.add( node );
    }
     ...
     */
    public enum Type {
        CU, FIELD, CONSTRUCTOR, METHOD, INTERFACE, CLASS, ANNOTATION, ENUM, RECORD
    }
    ...
    public boolean equals ( final Object obj ) {
        if ( ( obj != null ) && ( getClass() == obj.getClass() ) ) {
            final JavaStructureNode other = (JavaStructureNode) obj;
    ...
    public boolean isClassOrInterface () {
        return ( fType == Type.CLASS ) || ( fType == Type.INTERFACE ) || ( fType == Type.RECORD );
    }
    ...
    @Override
    public boolean isOfSameTypeAs ( final StructureNode other ) {
