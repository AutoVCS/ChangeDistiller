...
public class WhenDeclarationsAreConverted extends WhenASTsAreConverted {
    ...
    public void fieldDeclarationShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fField" );
        assertThat( getTreeString(), is( "fField {  { private },String,String }" ) );
        assertModifiersCorrectness( getFirstChild(), "private" );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithInitializerShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fField" );
        assertThat( getTreeString(), is( "fField {  { private },String,\"aString\",String }" ) );
        final Node initializer = getLastChild();
        assertThat( getSource( initializer ), is( "String" ) );
        assertThat( initializer.getLabel(), is( JavaEntityType.SINGLE_TYPE ) );
    }
    ...
    public void fieldDeclarationWithMultiModifiersShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fField" );
        assertThat( getTreeString(), is( "fField {  { private,final },String,String }" ) );
    ...
    public void fieldDeclarationWithTypeParameterShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,List<String>,List<String> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithQualifiedTypeParameterShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,List<Foo.Bar>,List<Foo.Bar> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithParameterizedQualifiedTypeParameterShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,List<Foo<T>.Bar>,List<Foo<T>.Bar> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithQualifiedParameterizedTypeParameterShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,List<Foo.Bar<T>>,List<Foo.Bar<T>> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithParameterizedTypeParameterShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,List<Bar<T>>,List<Bar<T>> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithMultipleTypeParametersShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,Map<String, Integer>,Map<String, Integer> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithWildcardShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,List<?>,List<?> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithUpperBoundedWildcardShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,List<? super Number>,List<? super Number> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationWithLowerBoundedWildcardShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fList" );
        assertThat( getTreeString(), is( "fList { ,List<? extends Number>,List<? extends Number> }" ) );
        final Node type = getFieldType();
    ...
    public void fieldDeclarationCompleteShouldBeConverted () throws Exception {
        ...
        prepareCompilation();
        convertField( "fMap" );
        assertThat( getTreeString(),
                is( "fMap {  { public,final },Map<? extends Number, String>,Map<? extends Number, String> }" ) );
    }
    ...
    public void fieldDeclarationWithJavadocShouldBeConverted () throws Exception {
        ...
        final Node javadoc = getFirstChild();
    ...
    public void fieldDeclarationWithEmptyJavadocShouldBeConvertedWithoutJavadoc () throws Exception {
        ...
        prepareCompilation();
        convertField( "aString" );
        assertThat( getTreeString(), is( "aString { ,String,String }" ) );
    }
    ...
    public void methodDeclarationWithReturnTypeShouldBeConverted () throws Exception {
        ...
        final Node returnType = getReturnType();
    ...
    public void methodDeclarationWithTypeArgumentShouldBeConverted () throws Exception {
        ...
        final Node typeArguments = (Node) getLastChild().getPreviousSibling().getPreviousSibling();
        assertThat( getSource( typeArguments ), is( "T" ) );
        assertThat( typeArguments.getLabel(), is( JavaEntityType.TYPE_PARAMETERS ) );
        final Node typeArgument = (Node) typeArguments.getFirstLeaf();
    ...
    public void methodDeclarationWithMultipleTypeArgumentsShouldBeConverted () throws Exception {
        ...
        assertThat( typeArguments.getLabel(), is( JavaEntityType.TYPE_PARAMETERS ) );
        final Node firstTypeArgument = (Node) typeArguments.getFirstLeaf();
        assertThat( getSource( firstTypeArgument ), is( "T" ) );
        assertThat( firstTypeArgument.getLabel(), is( JavaEntityType.TYPE_PARAMETER ) );
        final Node secondTypeArgument = (Node) firstTypeArgument.getNextSibling();
    ...
    public void methodDeclarationWithMultipleBoundedTypeArgumentShouldBeConverted () throws Exception {
        ...
        convertMethod( "method" );
        assertThat( getTreeString(),
                is( "method {  { public },method: void, { T extends Number & Serializable },, }" ) );
        final Node typeArguments = (Node) getLastChild().getPreviousSibling().getPreviousSibling();
    ...
    public void methodDeclarationWithMultipleThrowsShouldBeConverted () throws Exception {
        ...
        final Node firstException = (Node) exceptions.getFirstLeaf();
        assertThat( exceptions.getLabel(), is( JavaEntityType.THROW ) );
        assertThat( getSource( firstException ), is( "IOException" ) );
        assertThat( firstException.getLabel(), is( JavaEntityType.SINGLE_TYPE ) );
        final Node secondException = (Node) firstException.getNextSibling();
    ...
    public void methodDeclarationCompleteShouldBeConverted () throws Exception {
        ...
        convertMethod( "method" );
        assertThat( getTreeString(), is(
                "method {  { protected,final },method: String, { T }, { aList { aList: List<T> },anInteger { anInteger: int } }, { IOException } }" ) );
    }
    ...
    public void typeDeclarationWithTypeArgumentShouldBeConverted () throws Exception {
        ...
        final Node typeArguments = getTypeParameters();
        assertThat( getSource( typeArguments ), is( "T" ) );
        assertThat( typeArguments.getLabel(), is( JavaEntityType.TYPE_PARAMETERS ) );
        final Node typeArgument = (Node) typeArguments.getFirstLeaf();
        assertThat( getSource( typeArgument ), is( "T" ) );
    ...
    public void typeDeclarationWithSuperTypeShouldBeConverted () throws Exception {
        ...
        final Node superType = (Node) getLastChild().getPreviousSibling();
    ...
    public void typeDeclarationWithSuperInterfaceShouldBeConverted () throws Exception {
        ...
        convertClass( "Bar" );
        assertThat( getTreeString(), is( "Bar { ,, { Number } }" ) );
        final Node superInterfaces = getLastChild();
        ...
        final Node superInterface = (Node) superInterfaces.getFirstLeaf();
    ...
    public void typeDeclarationWithMultipleSuperInterfacesShouldBeConverted () throws Exception {
        ...
        assertThat( superInterfaces.getLabel(), is( JavaEntityType.SUPER_INTERFACE_TYPES ) );
        final Node firstSuperInterface = (Node) superInterfaces.getFirstLeaf();
        assertThat( getSource( firstSuperInterface ), is( "Number" ) );
        assertThat( firstSuperInterface.getLabel(), is( JavaEntityType.SINGLE_TYPE ) );
        final Node secondSuperInterface = (Node) firstSuperInterface.getNextSibling();
    ...
    private void assertModifiersCorrectness ( final Node modifiers, final String... modifierNames ) {
        String concatedModifiers = "";
        for ( final String modifier : modifierNames ) {
        ...
        int i = 0;
        for ( final Enumeration<Node> e = (Enumeration<Node>) (Enumeration< ? >) modifiers.children(); e
                .hasMoreElements(); i++ ) {
            final Node modifier = e.nextElement();
            assertThat( getSource( modifier ), is( modifierNames[i] ) );
            assertThat( modifier.getLabel(), is( JavaEntityType.MODIFIER ) );
        }
    }

    private String getSource ( final Node node ) {
        final SourceCodeEntity entity = node.getEntity();
        return fCompilation.getSource().substring( entity.getStartPosition(), entity.getEndPosition() + 1 );
    }

    @Override
    protected String getSourceCodeWithSnippets ( final String... sourceSnippets ) {
        final StringBuilder src = new StringBuilder( "public class Foo { " );
        for ( final String statement : sourceSnippets ) {
    ...
    private void convertField ( final String name ) {
        createRootNode( JavaEntityType.FIELD_DECLARATION, name );
        final FieldDeclaration field = CompilationUtils.findField( fCompilation.getCompilationUnit(), name );
    ...
    private void convertMethod ( final String name ) {
        createRootNode( JavaEntityType.METHOD_DECLARATION, name );
        final AbstractMethodDeclaration method = CompilationUtils.findMethod( fCompilation.getCompilationUnit(), name );
        method.traverse( getDeclarationconverter(), (ClassScope) null );
    }

    private void convertClass ( final String name ) {
        createRootNode( JavaEntityType.METHOD_DECLARATION, name );
        final TypeDeclaration type = CompilationUtils.findType( fCompilation.getCompilationUnit(), name );
